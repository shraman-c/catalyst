  ...
  async function handleExport(format: 'json' | 'csv') {
    ...
    try {
      ...
      if (res.ok) {
        ...
        a.href = url;
        a.download = `catalyst-export-${new Date().toISOString().split('T')[0]}.${format}`;
            ...
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              {([
                ...
                <button
                  ...
                  style={{ flex: '1 1 130px', flexDirection: 'column', padding: '12px 8px', height: 'auto' }}
                >
          ...
          <div className="bento-tile" style={{ borderStyle: 'dashed' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
              <input
                ...
                style={{ flex: '1 1 180px', maxWidth: '300px' }}
              />
              <button
